...
public class NavigationPageCucumber extends BasePageCucumber {
	

	public NavigationPageCucumber() {
	...
	public void navigationPP(String screen) throws InterruptedException
	{
		try {
