...
public class BasePage {
	...
	//	@Before
	public  void loginToEnv(String URL) throws InterruptedException
	{
		try {
			if(URL==("UAT2"))
			{
				driver.get("https://portaluat2.citidirect.com");
			}
			else if(URL.equalsIgnoreCase("UAT1"))
			{
				driver.get("https://portaluat1.citidirect.com");
			}
